...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class ServerAuditingPolicy : Resource
    {
        /// <summary>
        ...
        public ServerAuditingPolicy(string location, string name = default(string), string id = default(string), string type = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>), string auditingState = default(string), string eventTypesToAudit = default(string), string storageAccountName = default(string), string storageAccountKey = default(string), string storageAccountSecondaryKey = default(string), string storageTableEndpoint = default(string), string storageAccountResourceGroupName = default(string), string storageAccountSubscriptionId = default(string), string retentionDays = default(string), string auditLogsTableName = default(string), string fullAuditLogsTableName = default(string))
