...
namespace Microsoft.Azure.Management.Sql.Models
{
    ...
    public partial class DatabaseAuditingPolicy : SubResource
    {
        /// <summary>
        ...
        /// policy.</param>
        public DatabaseAuditingPolicy(string name = default(string), string id = default(string), string useServerDefault = default(string), string auditingState = default(string), string eventTypesToAudit = default(string), string storageAccountName = default(string), string storageAccountKey = default(string), string storageAccountSecondaryKey = default(string), string storageTableEndpoint = default(string), string storageAccountResourceGroupName = default(string), string storageAccountSubscriptionId = default(string), string retentionDays = default(string), string auditLogsTableName = default(string), string fullAuditLogsTableName = default(string))
            : base(name, id)
        {
